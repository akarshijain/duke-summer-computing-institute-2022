...
In eval.py, write:
  ...
  - count_values helper function, which takes a hand as a parameter
    and returns a dictionary which maps each card value
    to the number of cards in the hand with that value. For example
    if a hand contains three kings one queen and one 5, you would
    return {13 : 3, 12 : 1, 5: 1}.  Whether or not you want the dictionary
    to contain 0 entires for cards that are not in the hand is up to you.
    E.g. {14:0, 13:3, 12:1, 11:0, 10:0, 9:0, 8:0, 7:0, 6:0, 5:1, 4:0,
