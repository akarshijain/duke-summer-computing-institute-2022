...
example, if you look in /usr/local/sci/words/caesar.txt, which is
...
functions:
  - string.strip('-?.!,[]—:;"\'') will return a string with any leading
    or trailing occurrences of any of the characters -?.!,[]—:;"' removed 
    from it. 
...
To accomplish this, you will want to put the items from the dictionary
...
You may wish to make use of the other files in /usr/local/sci/words
